...
public class ConsPracrtical {
	public static void main(String[] args) {
		 ...
		 * id = sc.nextInt(); System.out.println("enter name : "); String name =
		 * sc.next(); User u1 = new User(); u1.setId(id); // u1.id=13; u1.setName(name);
		 * System.out.println(u1.getId()); System.out.println(u1.getName());
		 */
